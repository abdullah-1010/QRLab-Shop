          ...
          <form className={classes.form}>
            ...
            >
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The QR Lab Shop Terms & Conditions"
              ...
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The QR Lab Shop Terms Of Use"
                  className={classes.checkbox}
            ...
            >
              I acknowledge QR Lab Shop will use my information in accordance
              with its
